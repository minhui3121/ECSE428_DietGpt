...
Scenario Outline: Successful Meal Plan Generation (Normal Flow)
...
Scenario: Generate Meal Plan Fails Due to Insufficient Ingredients (Error Flow)
...
Scenario: Meal Plan Generated According to Dietary Restriction (Alternate Flow)
